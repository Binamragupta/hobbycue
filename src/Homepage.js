  ...
  return (
    <>
        <div>
            ...
            <div className="compo"><Cardsarea /></div>
            <div className="compo"><Addarea /></div>
            <div className="compo"><Testimonialsection /></div>
            <div className="compo"><Lastsection /></div>
            <div className="compo"><Bottom /></div>
        </div>
    </>
  )
}
